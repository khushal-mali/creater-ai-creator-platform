      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <CardContent>
            ...
            {stats.viewsGrowth > 0 && (
              <div className="mt-1 flex items-center text-xs text-green-400">
                <TrendingUp className="mr-1 h-3 w-3" />+{stats.viewsGrowth}%
                from last month
              </div>
            )}
          </CardContent>
        ...
        <Card className="card-glass">
          ...
          <CardContent>
            ...
            {stats.likesGrowth > 0 && (
              <div className="mt-1 flex items-center text-xs text-green-400">
                <TrendingUp className="mr-1 h-3 w-3" />+{stats.likesGrowth}%
                from last month
              </div>
            )}
          </CardContent>
        ...
        <Card className="card-glass">
          ...
          <CardContent>
            ...
            {stats.commentsGrowth > 0 && (
              <div className="mt-1 flex items-center text-xs text-green-400">
                <TrendingUp className="mr-1 h-3 w-3" />+{stats.commentsGrowth}%
                from last month
              </div>
            )}
          </CardContent>
        ...
        <Card className="card-glass">
          ...
          <CardContent>
            ...
            {stats.followersGrowth > 0 && (
              <div className="mt-1 flex items-center text-xs text-green-400">
                <TrendingUp className="mr-1 h-3 w-3" />+{stats.followersGrowth}%
                from last month
              </div>
            )}
          </CardContent>
            ...
            <CardContent>
              {postsLoading ? (
                ...
                <div className="py-8 text-center">
                  <p className="mb-4 text-slate-400">No posts yet</p>
                  <Link href="/dashboard/create">
                ...
                <div className="space-y-4">
                  {recentPosts.map((post) => (
                    <div
                      key={post._id}
                      className="flex cursor-pointer items-center justify-between rounded-lg bg-slate-800/30 p-4 transition-colors hover:bg-slate-700/30"
                      onClick={() =>
                        window.open(
