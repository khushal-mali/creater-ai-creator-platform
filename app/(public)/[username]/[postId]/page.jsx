      ...
      <div className="mx-auto max-w-4xl px-6 py-8">
        <article className="space-y-8">
          ...
          <div className="space-y-4">
            <h1 className="gradient-text-primary text-4xl font-bold md:text-5xl">
              {post.title}
            </h1>

            <div className="flex items-center justify-between">
              <Link href={`/${username}`}>
                <div className="flex items-center space-x-3 transition-opacity hover:opacity-80">
              ...
              <CardContent className="p-6">
                <form onSubmit={handleCommentSubmit} className="space-y-4">
                  <Textarea
                    ...
                    className="resize-none border-slate-600 bg-slate-800 text-white placeholder:text-slate-400"
                    rows={3}
                    maxLength={1000}
                  />
