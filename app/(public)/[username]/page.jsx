        ...
        <div className="mb-12 text-center">
          <div className="relative mx-auto mb-6 h-24 w-24">
            {user?.imageUrl ? (
              ...
              <div className="flex h-full w-full items-center justify-center rounded-full bg-linear-to-br from-purple-600 to-blue-600 text-2xl font-bold">
                {user.name.charAt(0).toUpperCase()}
              </div>
            )}
          </div>

          <h1 className="gradient-text-primary mb-2 text-4xl font-bold">
            {user.name}
          </h1>

          <p className="mb-4 text-xl text-slate-400">@{user.username}</p>
